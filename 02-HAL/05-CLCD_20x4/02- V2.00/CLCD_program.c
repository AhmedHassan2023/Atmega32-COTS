...
#if ( (CURSOR_DISPLAY == CURSOR_DISPLAY_ON) && (CURSOR_BLINK == CURSOR_BLINK_ON) )
	/* 1- CURSOR: ON			BLINK: ON */
	CLCD_voidSetHalfDataPort(0b1111);
	CLCD_voidSendEnablePulse();

#elif( (CURSOR_DISPLAY == CURSOR_DISPLAY_ON) && (CURSOR_BLINK == CURSOR_BLINK_OFF) )
	/* 2- CURSOR: ON			BLINK: OFF */
	CLCD_voidSetHalfDataPort(0b1110);
	CLCD_voidSendEnablePulse();

#elif( (CURSOR_DISPLAY == CURSOR_DISPLAY_OFF) && (CURSOR_BLINK == CURSOR_BLINK_OFF) )
	/* 3- CURSOR: OFF			BLINK: OFF */
	CLCD_voidSetHalfDataPort(0b1100);
	CLCD_voidSendEnablePulse();
...
static void CLCD_voidSetDataPort(u8 Copy_u8Data)
{
	...
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D0_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,1);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D1_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,2);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D2_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,3);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D3_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,4);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D4_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,5);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D5_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,6);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D6_PIN,Local_u8BitValue);

	Local_u8BitValue = GET_BIT(Copy_u8Data,7);
	DIO_u8SetPinValue(CLCD_DATA_PORT,CLCD_D7_PIN,Local_u8BitValue);
